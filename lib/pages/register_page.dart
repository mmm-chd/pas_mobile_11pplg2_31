        ...
        children: [
          ...
          CustomScrollView(
            slivers: [
              ...
              SliverToBoxAdapter(
                child: Padding(
                  padding: const EdgeInsets.only(right: 14, top: 40, left: 14),
                  child: Column(
                              ...
                              children: [
                                ...
                                Obx(
                                  () => MytextfieldWidget(
                                    ...
                                    obscureText:
                                        registerController.isObsecure.value,
                                    suffixIcon: InkWell(
                                      onTap: registerController.tooglePassword,
                                      child: registerController.isObsecure.value
